...
.. image:: images/fig.png
   :alt: plot that was generated by the figure named ``fig`` in the example
   :align: center
   :width: 80%
...
.. image:: images/group_fig.png
   :alt: plot that was generated by the figure named ``groupby_fig`` in the example
   :align: center
   :width: 80%
